...
func NewEnduroStoredPipeline(vres *pipelineviews.EnduroStoredPipeline) *EnduroStoredPipeline {
	var res *EnduroStoredPipeline
	switch vres.View {
	case "default", "":
		res = newEnduroStoredPipeline(vres.Projected)
	}
	return res
}
...
func NewViewedEnduroStoredPipeline(res *EnduroStoredPipeline, view string) *pipelineviews.EnduroStoredPipeline {
	var vres *pipelineviews.EnduroStoredPipeline
	switch view {
	case "default", "":
		p := newEnduroStoredPipelineView(res)
		vres = &pipelineviews.EnduroStoredPipeline{Projected: p, View: "default"}
	}
	return vres
}
