...
// RecvWithContext reads instances of "collection.EnduroMonitorUpdate" from the
// "monitor" endpoint websocket connection with context.
func (s *MonitorClientStream) RecvWithContext(ctx context.Context) (*collection.EnduroMonitorUpdate, error) {
	return s.Recv()
}
