...
// Send Send streams instances of "collection.EnduroMonitorUpdate" to the
// "monitor" endpoint SSE connection.
...
// "collection.EnduroMonitorUpdate" to the "monitor" endpoint SSE connection
// with context.
func (s *MonitorServerStream) SendWithContext(ctx context.Context, v *collection.EnduroMonitorUpdate) error {
	s.once.Do(func() {
		header := s.w.Header()
