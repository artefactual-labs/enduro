...
// endpoint.
func DecodeSubmitRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (*batch.SubmitPayload, error) {
	return func(r *http.Request) (*batch.SubmitPayload, error) {
		var payload *batch.SubmitPayload
		var (
