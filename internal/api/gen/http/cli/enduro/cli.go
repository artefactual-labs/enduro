...
func UsageExamples() string {
	return os.Args[0] + ` collection list --name "Non illo." --original-id "Eos maiores." --transfer-id "95545D09-3153-0F17-09F7-7FEB1545D780" --aip-id "AC77D914-0A36-9917-2BA7-F519556A50B8" --pipeline-id "A129B534-C1FC-F09D-BF29-3DA5781E0ECB" --earliest-created-time "2005-01-01T00:19:43Z" --latest-created-time "1998-01-29T14:22:39Z" --status "unknown" --cursor "Architecto ab."` + "\n" +
		os.Args[0] + ` pipeline list --name "Repudiandae dicta."` + "\n" +
		""
}
...
Example:
    `+os.Args[0]+` collection list --name "Non illo." --original-id "Eos maiores." --transfer-id "95545D09-3153-0F17-09F7-7FEB1545D780" --aip-id "AC77D914-0A36-9917-2BA7-F519556A50B8" --pipeline-id "A129B534-C1FC-F09D-BF29-3DA5781E0ECB" --earliest-created-time "2005-01-01T00:19:43Z" --latest-created-time "1998-01-29T14:22:39Z" --status "unknown" --cursor "Architecto ab."
`, os.Args[0])
}
...
Example:
    `+os.Args[0]+` collection show --id 3884271663565536973
`, os.Args[0])
}
...
Example:
    `+os.Args[0]+` collection delete --id 14647263055470911160
`, os.Args[0])
}
...
Example:
    `+os.Args[0]+` collection cancel --id 223800609447333041
`, os.Args[0])
}
...
Example:
    `+os.Args[0]+` collection retry --id 3888991075813324004
`, os.Args[0])
}
...
Example:
    `+os.Args[0]+` collection workflow --id 1777039972501742474
`, os.Args[0])
}
...
Example:
    `+os.Args[0]+` collection download --id 2066674967718758770
`, os.Args[0])
}
...
Example:
    `+os.Args[0]+` collection decide --body '{
      "option": "Molestias quae."
   }' --id 2704045210694776917
`, os.Args[0])
}
...
Example:
    `+os.Args[0]+` pipeline show --id "76150F6F-C16D-33A6-B049-F5AE2D7C6385"
`, os.Args[0])
}
