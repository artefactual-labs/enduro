...
type MonitorServerStream interface {
	...
	// SendWithContext streams instances of "EnduroMonitorUpdate" with context.
	SendWithContext(context.Context, *EnduroMonitorUpdate) error
	// Close closes the stream.
	Close() error
}

// MonitorClientStream allows streaming instances of *EnduroMonitorUpdate to
// the client.
type MonitorClientStream interface {
	...
	// RecvWithContext reads instances of "EnduroMonitorUpdate" from the stream
	// with context.
	RecvWithContext(context.Context) (*EnduroMonitorUpdate, error)
}
